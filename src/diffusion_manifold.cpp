...
void GMLS_Solver::DiffusionEquationManifold() {
  ...
  //       "neighbor lists", numTargetCoords,
  ...
  //   postProcessingBasis.setProblemData(neighborListsDevice,
  //   sourceCoordsDevice,
  //                                      targetCoordsDevice, epsilonDevice);

  //   postProcessingBasis.setReferenceOutwardNormalDirection(normalDevice,
  //   true);
  ...
  //   for (int i = 0; i < 3; i++)
  //     postProcessingGradientIndex[i] =
  //     postProcessingBasis.getAlphaColumnOffset(
