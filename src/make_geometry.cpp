...
//   static vector<double> &rigidBodySize =
//   __rigidBody.scalar.GetHandle("size");
...
//         __boundingBoxSize, __boundingBoxCount, __boundingBox,
//         __particleSize0,
...
//   // first init the particles on the surface of colloids, then when adding
//   field
...
//   number"); static auto &attachedRigidBodyIndex =
//       __field.index.GetHandle("attached rigid body index");
...
//         InsertParticle(pos, 1, __particleSize0, boundary_normal, localIndex,
//         0,
//                        vol);
//       }
...
//         InsertParticle(pos, 2, __particleSize0, boundary_normal, localIndex,
//         0,
//                        vol);
...
//   if (__dim == 3) {
//     double vol = __particleSize0[0] * __particleSize0[1] *
//     __particleSize0[2]; int localIndex = 0;
...
//           InsertParticle(pos, 2, __particleSize0, normal, localIndex, 0,
//           vol); yPos += __particleSize0[1];
//         }
//       }
...
//           InsertParticle(pos, 3, __particleSize0, normal, localIndex, 0,
//           vol); yPos += __particleSize0[1];
//         }
...
//           vec3 pos = vec3(xPos, yPos, zPos);
//           normal = vec3(1.0, 0.0, 0.0);
//           InsertParticle(pos, 0, __particleSize0, normal, localIndex, 0,
//           vol); yPos += __particleSize0[1];
//         }
...
//   if (__dim == 3) {
//     double vol = __particleSize0[0] * __particleSize0[1] *
//     __particleSize0[2]; int localIndex = coord.size();

//     vec3 startPos, endPos;
//     // face
//     // front
//     if (__domainBoundaryType[0] != 0) {
//       startPos = vec3(__domain[1][0], __domain[0][1] + __particleSize0[1] /
//       2,
...
//     // back
//     if (__domainBoundaryType[2] != 0) {
//       startPos = vec3(__domain[0][0], __domain[0][1] + __particleSize0[1] /
//       2,
//                       __domain[0][2] + __particleSize0[2] / 2);
...
//     if (__domainBoundaryType[3] != 0) {
//       startPos = vec3(__domain[0][0] + __particleSize0[0] / 2,
//                       __domain[0][1] + __particleSize0[1] / 2,
//                       __domain[0][2]);
...
//   auto &gap_particle_adaptive_level = __gap.index.GetHandle("adaptive
//   level");
...
//   auto &gapRigidBodyCoord = __gap.vector.GetHandle("rigid body surface
//   coord");
...
//   static vector<int> &particleNum = __field.index.GetHandle("particle
//   number"); int &localParticleNum = particleNum[0];
...
//       vec3 dis = backgroundSourceCoord[neighborLists(i, j + 1)] -
//       gapCoord[i]; if (dis.mag() < min_dis) {
//         min_dis = dis.mag();
...
//     gapRigidBodyParticleSplitTag[i] = gapParticleSplitTag[i +
//     gapCoord.size()];
//   }
...
//           } else {
//             double vol = volume[tag];
//             InitWallFaceParticle(newPos, particleType[tag],
//             particleSize[tag],
//                                  normal[tag], localIndex,
//                                  adaptive_level[tag], vol);
//             splitList[tag].push_back(localIndex - 1);
//           }
//         }
//       } else {
...
//                        oldGapParticleSize[tag], oldGapNormal[tag],
//                        localIndex, oldGapParticleAdaptiveLevel[tag],
//                        oldGapParticleSize[tag][0] *
...
//               vec3 newPos = origin + vec3(i * xDelta, j * yDelta, k *
//               zDelta); double vol = oldGapParticleSize[tag][0] *
//                            oldGapParticleSize[tag][1] *
//                            oldGapParticleSize[tag][2] / 8.0;
//               InsertParticle(newPos, oldGapParticleType[tag],
//               newParticleSize,
