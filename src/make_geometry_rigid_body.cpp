...
//   __rigidBody.scalar.GetHandle("size"); static auto &rigidBodyType =
//   __rigidBody.index.GetHandle("type");
...
//   static vector<double> &rigidBodySize =
//   __rigidBody.scalar.GetHandle("size"); static auto &rigidBodyType =
//   __rigidBody.index.GetHandle("type"); static vector<vec3> &fluidCoord =
//   __field.vector.GetHandle("coord");
...
//             if (pos[0] >= __domain[0][0] && pos[0] < __domain[1][0] &&
//                 pos[1] >= __domain[0][1] && pos[1] < __domain[1][1])
//               InsertParticle(pos, 5, particleSize, normal, localIndex, 0,
//               vol,
//                              true, n, pCoord);
//           }
//         }
...
//           int particleNumPerSize = rigidBodySize[n] * 2.0 /
//           __particleSize0[0];
...
//                              sin(theta) * norm[0] + cos(theta) * norm[1],
//                              0.0);
...
//             InsertParticle(newPos, 4, particleSize, normal, localIndex, 0,
//             vol,
//                            true, n, pCoord);
//         }
...
//           if (newPos[0] >= __domain[0][0] && newPos[0] < __domain[1][0] &&
//               newPos[1] >= __domain[0][1] && newPos[1] < __domain[1][1])
//             InsertParticle(newPos, 5, particleSize, normal, localIndex, 0,
//             vol,
//                            true, n, pCoord);
//         }
...
//               attachedRigidBodyIndex[tag], vec3(theta - thetaDelta, 0.0,
//               0.0));
...
//       int attachedRigidBodyIndex =
//       oldGapRigidBodyAttachedRigidBodyIndex[tag]; switch
//       (rigidBodyType[attachedRigidBodyIndex]) { case 1:
//         // cicle
//         {
...
//           oldGapRigidBodyAdaptiveLevel[tag], oldGapRigidBodyVolume[tag],
//           true, oldGapRigidBodyAttachedRigidBodyIndex[tag],
